      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <ul>
              <li><a href="openmindrobotics.com/vn" className="hover:text-1xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-200">Trang chủ</a></li>
              <li><a href="#" className="hover:text-1xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-200">Giải pháp</a></li>
              <li><a href="#" className="hover:text-1xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-200">Công nghệ</a></li>
              <li><a href="#" className="hover:text-1xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-200">Liên hệ</a></li>
            </ul>
          </div>
          <div className="w-full md:w-1/3">
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex flex-wrap items-center">
                ...
                />
                <MagicButton title="Đăng ký" icon={undefined} position={''} />
              </div>
